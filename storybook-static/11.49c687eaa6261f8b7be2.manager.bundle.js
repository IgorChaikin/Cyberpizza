                ...
                EASING =
                  ...
                  }),
                  {
                    ...
                    easeOutBack: function (x, t, b, c, d, s) {
                      return (
                        c * ((t = t / d - 1) * t * (((s = s || _easingsMath.o) + 1) * t + s) + 1) +
                        b
                      );
                    },
                  ...
                  function OverlayScrollbarsGlobals(defaultOptions) {
                    ...
                    FRAMEWORK.extend(_base, {
                      ...
                      restrictedMeasuring: (function () {
                        ...
                        return (
                          scrollSize.w - scrollSize2.w != 0 || scrollSize.h - scrollSize2.h != 0
                        );
                      })(),
                    ...
                    function update(updateHints) {
                      ...
                      if (
                        ...
                        (_lastUpdateTime = now),
                          ...
                          (_nativeScrollbarMinSize = {
                            x:
                              3 * (_nativeScrollbarSize.x + (_nativeScrollbarIsOverlaid.x ? 0 : 3)),
                            y:
                              3 * (_nativeScrollbarSize.y + (_nativeScrollbarIsOverlaid.y ? 0 : 3)),
                          }),
                            ...
                            setOverflowVariables = function (horizontal) {
                              ...
                              (overflowBehaviorIsVS[xy] = 'v-s' === overflowBehavior[xy]),
                                ...
                                (overflowAmount[xy] = MATH.max(
                                  0,
                                  MATH.round(100 * (contentScrollSize[wh] - _viewportSize[wh])) /
                                    100
                                )),
                                (overflowAmount[xy] *=
